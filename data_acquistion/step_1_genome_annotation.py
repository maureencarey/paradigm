...
os.chdir(data_path)
annotations_df.to_csv('bigg_annotations_per_genome_jan2019.csv')
...
pd.DataFrame.from_dict(annot_count, orient="index").to_csv("annotation_count_all_species_jan2019.csv")
pd.DataFrame.from_dict(annot_count_unique_genes, orient="index").to_csv("unique_gene_annotation_count_all_species_jan2019.csv")
...
os.chdir(data_path)
annotations_ortho_df.to_csv('ortho_annotations_per_genome_jan2019.csv')
