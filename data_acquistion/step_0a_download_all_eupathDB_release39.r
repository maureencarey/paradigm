...
fungidb_orf = c(fungidb,"CimmitisRMSCC2394","CimmitisRMSCC3703","CposadasiiCPA0001","CposadasiiCPA0020","CposadasiiCPA0066", "CposadasiiRMSCC1037", "CposadasiiRMSCC1038", "CposadasiiRMSCC2133")
...
# # ORF - AA
# genomes = vector(mode = "list", length = 9)
# genomes[[1]] = plasmodb_orf; genomes[[2]] = cryptodb_orf; genomes[[3]] = giardiadb_orf; genomes[[4]] =  tritrypdb_orf; genomes[[5]] = trichdb_orf; genomes[[6]] = amoebadb_orf; genomes[[7]] = toxodb_orf; genomes[[8]] = microsporidiadb_orf; genomes[[9]] = piroplasmadb_orf; # genomes[[10]] = fungidb_orf
# # setwd("/scratch/glm5uh/eupathdb2models/genomes_from_EuPathDB/version39/orf")
# wd_String = "/Users/maureencarey/local_documents/work/comparative_parasite_models/paradigm/data"
# for (i in 1:length(genomes)) { genomes_list = genomes[[i]]; db_name_uc = DataBase_uc[i]; db_name_lc = database_lc[i]
#     for (x in genomes_list) {
#         upstream_link = paste(paste("http://",db_name_lc,sep = ""),".org/common/downloads/Current_Release/", sep = "")
#         middle_link = paste(paste(x,'/fasta/data/', sep = ""),db_name_uc, sep = "")
#         downstream_link = paste(paste(version, x, sep = "_"),"_ORFs_AA.fasta", sep = "")
#         link = (paste(paste(upstream_link,middle_link,sep = ""), downstream_link,sep = "-"))
#         # print(link)
#         destination = paste(wd_String,paste(x,paste("ORFs_Oct2018",".fasta", sep = ""), sep = "_"), sep = "/")
#         print(destination)
#         if (!url.exists(link)) {
#             print('------------------------------------------------------')
#             print('DOES NOT EXIST')
