...
logging.basicConfig(filename='step6_for_sensitivity_{}{}_{}.log'.format(ortho,SPECIES_ID,day), level=logging.INFO, filemode='w')
...
df.to_csv('gapfilling_additions_for_sensitivity_{}{}_tasks.csv'.format(ortho,SPECIES_ID))
...
cobra.io.write_sbml_model(model,'for_sensitivity_gf_{}{}.xml'.format(ortho,SPECIES_ID))
