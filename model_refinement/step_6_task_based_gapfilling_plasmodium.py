...
logging.basicConfig(filename='step6_no_ortho_{}_{}.log'.format(SPECIES_ID,day), level=logging.INFO, filemode='w')
...
#    logger.info(model.objective.expression)
    ...
    os.chdir(model_path)
    cobra.io.save_json_model(model, 'gf_without_ortho_'+SPECIES_ID+'.json')
