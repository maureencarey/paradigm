...
model_dict['P. berghei ANKA'] = cobra.io.read_sbml_model('gf_PbergheiANKA.xml')
model_dict['P. vivax Sal1'] = cobra.io.read_sbml_model('gf_PvivaxSal1.xml')
model_dict['C. hominis TU502 (2012)'] = cobra.io.read_sbml_model('gf_no_ortho_ChominisTU502_2012.xml')
model_dict['C. parvum Iowa II'] = cobra.io.read_sbml_model('gf_no_ortho_CparvumIowaII.xml')
model_dict['E. histolytica HM1IMSS-A'] = cobra.io.read_sbml_model('gf_no_ortho_EhistolyticaHM1IMSS-A.xml')
model_dict['L. major SD75'] = cobra.io.read_sbml_model('gf_no_ortho_LmajorSD75.xml')
model_dict['T. cruzi CL Brener'] = cobra.io.read_sbml_model('gf_no_ortho_TcruziCLBrener.xml')
model_dict['T. brucei Lister 427'] = cobra.io.read_sbml_model('gf_no_ortho_TbruceiLister427.xml')
model_dict['V. brassicaformis CCMP3155'] = cobra.io.read_sbml_model('gf_no_ortho_VbrassicaformisCCMP3155.xml')
model_dict['B. bovis T2Bo'] = cobra.io.read_sbml_model('gf_no_ortho_BbovisT2Bo.xml')
model_dict['N. fowleri ATCC30863'] = cobra.io.read_sbml_model('gf_no_ortho_NfowleriATCC30863.xml')
print('models loaded')
...
for met_id in met_list:
    ...
    # save
    matrix_of_results_for_a_met.to_csv("/home/mac9jc/paradigm/data/results/biomass_precursors/biomass_precursors_essentiality_matrix_{}_{}.csv".format(met_id,day))
